...
- **HTML**, **CSS**, and **Javascript** with [Bootstrap 3](https://getbootstrap.com/docs/3.4/customize/) (Frontend)
...
4. Create a PostgreSQL DB locally

```bash
$ createdb fyyur
```

5. Update your DB URI under [config.py](./config.py)
...
7. Navigate to Homepage [http://localhost:5000](http://localhost:5000)
